...
class WBStatusPictureView: UICollectionView {
    ...
    init() {
        ...
        // 注册cell
        registerClass(WBStatusPictureViewCell.self, forCellWithReuseIdentifier: identifier)
...
extension WBStatusPictureView: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func collectionView(collectionView: UICollectionView, cellForItemAtIndexPath indexPath: NSIndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCellWithReuseIdentifier(identifier, forIndexPath: indexPath) as! WBStatusPictureViewCell
