...
public class HYLabel: UILabel {
    ...
    public var linkTextColor = UIColor(red: 127/255, green: 158/255, blue: 196/255, alpha: 1.0)
    public var selectedBackgroudColor = UIColor(red: 46/255, green: 175/255, blue: 252/255, alpha: 0.7)
    // MARK:- 属性
    // 重写系统的属性
...
extension HYLabel {
    ...
    private func prepareText() {
        ...
        var linkString = attrString!.string
        // 匹配规则
        ...
        // 匹配
        let result = regular.matchesInString(linkString, options: NSMatchingOptions(rawValue: 0), range: NSRange(location: 0, length: linkString.characters.count))
        ...
        attrString = NSAttributedString(string: linkString)
        ...
        if let linkRanges = getLinkRanges() {
            ...
            for range in linkRanges {
                textStorage.addAttribute(NSForegroundColorAttributeName, value: selectedBackgroudColor, range: range)
            }
